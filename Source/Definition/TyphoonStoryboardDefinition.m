...
- (id)targetForInitializerWithFactory:(TyphoonComponentFactory *)factory args:(TyphoonRuntimeArguments *)args
{
    ...
    TyphoonViewControllerBaseClass *result = [TyphoonViewControllerFactory viewControllerWithStoryboardContext:self.context injectionContext:injectionContext factory:factory];
    return result;
}
