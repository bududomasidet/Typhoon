...
- (id)scopeCachedViewControllerForInstance:(TyphoonViewControllerBaseClass *)instance typhoonKey:(NSString *)typhoonKey
{
    @synchronized (self) {
        [self loadIfNeeded];
...
- (TyphoonDefinition *)definitionForInstance:(TyphoonViewControllerBaseClass *)instance typhoonKey:(NSString *)typhoonKey
{
