...
- (id)instantiateViewControllerWithIdentifier:(NSString *)nibName
{
    ...
    if (!viewControllerClass) {
        viewControllerClass = [TyphoonViewControllerBaseClass class];
        LogInfo(@"*** Warning *** NSClassFromString(%@) is nil. %@ class will be used instead. "
                "This can lead to 'this class is not key value coding-compliant for the key' exception.", nibName, NSStringFromClass([TyphoonViewControllerBaseClass class]));
    }
